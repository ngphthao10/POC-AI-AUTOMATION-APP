...
* automate VIB Customer Service Portal administrative tasks. [This sample](./src/nova_act/samples/vib_csp_automation/) demonstrates role and branch management automation for IT support teams.
